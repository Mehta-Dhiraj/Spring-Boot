...
<body>
	<nav class="navbar navbar-expand-sm navbar-light" style="background-color:#5cb0bd">
		<a class="navbar-brand" href="/"> <img src="/img/headLogo.png"
			...
			loading="lazy"></a>
		<ul class="navbar-nav">
			<li class="nav-item mr-sm-4"><a class="nav-link" href="/"><b>Home</b></a>
			</li>
			<li class="nav-item mr-sm-4"><a class="nav-link"
				href="/cityList"><b>All School in ${city}</b></a></li>
		</ul>
		<div class="ml-auto">
			<a class="nav-link btn btn-primary" href="/admin">Admin</a>
		</div>
	</nav>
	<div class="container">
